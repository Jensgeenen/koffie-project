...
try:
        while True:
                if (GPIO.input (17)==0): #input low active
                        ...
                        # Write some text.
                        nummer=69
                        draw.text((1,0), 'omasaandetop!', font=font)
                        draw.text((1,8), 'het feesten', font=font)
                        draw.text((1,16), 'kan niet op', font=font)
                        draw.text((1,24), 'HARDCORE', font=font)
                        draw.text((1,32), (str(nummer) +'test'), font=font)
                        display.image(image)
                        display.show()
